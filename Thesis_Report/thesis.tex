...
\textbf{Method} & \textbf{Recall@10} & \textbf{Recall@50} & \textbf{Recall@100} & \textbf{Recall@1000} \\
\midrule
BGE-M3        & 0.009 & 0.046 & 0.091 & 0.704 \\
GTE-large     & 0.010 & 0.047 & 0.093 & \textbf{0.768} \\
E5-Mistral-7B & 0.006 & 0.029 & 0.052 & 0.274 \\
Linq-Mistral  & 0.009 & 0.046 & 0.091 & 0.749 \\
SFR-Mistral   & 0.009 & \textbf{0.046} & \textbf{0.092} & 0.746 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lc}
\toprule
\textbf{Method} & \textbf{Recall@1000} \\
\midrule
BM25 (lexical baseline, Section~\ref{sec:baseline_sparse}) & 0.635 \\
SimLM                                                       & 0.609 \\
MiniLM (Section~\ref{subsec:minilm})                        & 0.741 \\
GTE-large (Section~\ref{sec:extended_baselines})            & 0.768 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[ht]
\centering
\caption{Full-pool reranking Recall@1000 (relaxed top-1\,000 protocol),
...
\begin{tabular}{lcc}
\toprule
\textbf{Method} & \textbf{Recall@1000} & \textbf{Avg.\ pool size} \\
\midrule
RRF~+~top-50 rerank (Section~\ref{sec:rrf})    & 0.782 & 50 (fixed) \\
Full-pool, 2-way (MiniLM~+~Linq)               & 0.802 & $\approx$1\,300 \\
Full-pool, 3-way (+~GTE-large)                 & \textbf{0.804} & $\approx$1\,424 \\
Full-pool, 4-way (+~OpenAI-large)              & 0.802 & $\approx$1\,600 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lc}
\toprule
\textbf{Reranker} & \textbf{Recall@1000} \\
\midrule
BAAI/bge-reranker-v2-m3 (Section~\ref{sec:hybrid_fullpool})  & \textbf{0.8042} \\
mixedbread-ai/mxbai-rerank-large-v1                          & 0.8035 \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Method} & \textbf{Recall@1000} \\
\midrule
Full-pool, 3-way + BGE reranker (Section~\ref{sec:hybrid_fullpool}) & 0.804 \\
Learned fusion, logistic regression                                 & 0.821 \\
Learned fusion, gradient-boosted trees                               & \textbf{0.823} \\
\bottomrule
\end{tabular}
\end{table}
