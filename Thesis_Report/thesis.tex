...
\begin{table}[ht]
\centering
\caption{Extended baseline results under the relaxed (top-1\,000)
...
& \textbf{10} & \textbf{50} & \textbf{100} & \textbf{1000} \\
\midrule
BGE-M3        & 0.935 & 0.921 & 0.911 & 0.732 & 0.009 & 0.046 & 0.091 & 0.704 \\
GTE-large     & \textbf{0.946} & \textbf{0.937} & \textbf{0.929} & \textbf{0.790} & 0.010 & 0.047 & 0.093 & \textbf{0.768} \\
E5-Mistral-7B & 0.631 & 0.587 & 0.544 & 0.303 & 0.006 & 0.029 & 0.052 & 0.274 \\
Linq-Mistral  & 0.936 & 0.925 & 0.918 & 0.772 & 0.009 & 0.046 & 0.091 & 0.749 \\
SFR-Mistral   & 0.938 & 0.926 & 0.919 & 0.770 & 0.009 & \textbf{0.046} & \textbf{0.092} & 0.746 \\
\bottomrule
\end{tabular}
\end{table}
...
(NDCG@10~=~0.946, Recall@1000~=~0.790), ahead of SFR-Mistral
(0.938 / 0.770), Linq-Mistral (0.936 / 0.772), and BGE-M3
(0.935 / 0.732). These four sit close together and clearly ahead of
E5-Mistral-7B-Instruct, which substantially underperforms
(NDCG@10~=~0.631, Recall@1000~=~0.303) despite sharing the same base
architecture and parameter count as Linq-Mistral and SFR-Mistral --
indicating that fine-tuning data and strategy, not model size, are the
dominant factor for this retrieval task. Notably, the two much smaller
1\,024-dimensional models (BGE-M3, GTE-large) are competitive with or
better than the 7B-parameter models, at a fraction of the encoding
cost.
