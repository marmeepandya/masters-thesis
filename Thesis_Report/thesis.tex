...
\begin{table}[ht]
\centering
\caption{Cross-validated logistic regression feature weights, original
         (circular) ground truth vs.\ the new pooled gold standard.}
\label{tab:pooled_weights}
\small
\setlength{\tabcolsep}{6pt}
\begin{tabular}{lrr}
\toprule
\textbf{Feature} & \textbf{Original weight} & \textbf{New weight} \\
\midrule
invrank\_minilm  & $+5.014$ & $-0.909$ \\
score\_linq      & $+1.097$ & $+1.965$ \\
invrank\_gte     & $+0.958$ & $+0.323$ \\
score\_gte       & $+0.921$ & $+0.791$ \\
invrank\_linq    & $+0.867$ & $+0.416$ \\
score\_minilm    & $+0.749$ & $-0.146$ \\
n\_channels      & $+0.459$ & $-0.289$ \\
invrank\_bm25    & $-0.258$ & $-1.252$ \\
reranker\_score  & $+0.164$ & $+0.319$ \\
score\_bm25      & $+0.054$ & $-0.134$ \\
\bottomrule
\end{tabular}
\end{table}
