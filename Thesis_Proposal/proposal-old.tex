...
Modern company intelligence platforms maintain datasets containing 40M company profiles. These systems are used to identify relevant companies for tasks such as market analysis, strategic decision-making.
...
Retrieval performance will be measured using standard information retrieval metrics such as Precision@k, Recall@k, and NDCG@k, computed over the top-k retrieved companies. The embedding-based method will be compared against the production search system and the BM25 baseline. Evaluation will be conducted using a set of real-world queries and corresponding relevance judgments.
