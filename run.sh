#!/bin/bash
#SBATCH --job-name=48_encode_bge_large_scaled
#SBATCH --partition=gpu_a100_short
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=00:30:00
#SBATCH --output=/home/ma/ma_ma/ma_mpandya/Thesis/logs/48_encode_bge_large_scaled_%j.out
#SBATCH --error=/home/ma/ma_ma/ma_mpandya/Thesis/logs/48_encode_bge_large_scaled_%j.err
...
jupyter nbconvert --to script 48_encode_bge_large_scaled.ipynb
mv 48_encode_bge_large_scaled.txt 48_encode_bge_large_scaled.py

python 48_encode_bge_large_scaled.py
