#!/bin/bash
#SBATCH --job-name=05_baseline_nomic_summary
#SBATCH --partition=gpu_a100_short
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=00:30:00
#SBATCH --output=/home/ma/ma_ma/ma_mpandya/Thesis/logs/05_baseline_nomic_summary_%j.out
#SBATCH --error=/home/ma/ma_ma/ma_mpandya/Thesis/logs/05_baseline_nomic_summary_%j.err
...
jupyter nbconvert --to script 05_baseline_nomic_summary.ipynb

# nbconvert saves as .txt — rename to .py before running
mv 05_baseline_nomic_summary.txt 05_baseline_nomic_summary.py

python 05_baseline_nomic_summary.py
